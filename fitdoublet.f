...
c parameters are cont, inty1, wl1, sigma, inty2, wl2/wl1 
...
c      subroutine fitgaus(x,y,yerr,np,pars,errpars,npars,ifit,iguess)
      subroutine fitdoublet(x,y,yerr,n,pars,errpars,ifit,iguess,
     $     chisq,ier)
...
c      end do
     ...
     $     covar,alpha,npars,chisq,gausdoublet,ifconv)
...
c      chisq = chisq / real(n-nfit)
      ...
      subroutine gausdoublet(x,pars,y,dydpar,npar)

c parameters are cont, inty1, x1, sigma, inty2, x2/x1
